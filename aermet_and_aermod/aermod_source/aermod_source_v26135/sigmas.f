...
C        PROGRAMMER: Roger Brode and Jim Paumier, PES, Inc
C
C        MODIFIED:Modified to add PLUME_SPREAD for Aircraft sources instead of plume rise.
...
C        Use PLUME_SPREAD values calculated in PLUME_TRAJ subroutine
            SZB = PLUME_SPREAD/5.93D0
            SYB = PLUME_SPREAD/2.28D0
            SZBD = 0.0D0
            SZBN = 0.0D0
            SYB3 = 0.0D0
            SZB3 = 0.0D0
